...
#define _build_sysnum_enum_(name, number) SYS_##name = number
	...
	enum SyscallNumber
	{
		...
		_build_sysnum_enum_(getegid, 177),
		_build_sysnum_enum_(gettid, 178),
		...
		_build_sysnum_enum_(madvise, 233),
		_build_sysnum_enum_(wait, 260),
		_build_sysnum_enum_(prlimit64, 261),
		_build_sysnum_enum_(renameat2, 276),
